...
export default function WaifindPage() {
  const project = waifind
          ...
          <div className="container mx-auto px-6 md:px-8">
            <div className="max-w-6xl mx-auto">
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 0.2 }}
                viewport={{ once: true }}
                className="bg-[hsl(var(--project-color)/5%)] p-8 rounded-xl text-center"
              >
                <h3 className="text-2xl font-bold mb-4">Coming Soon</h3>
                <p className="text-muted-foreground">
                  This project is currently in development. More details and case study content will be available soon.
                </p>
              </motion.div>
            </div>
          </div>
